...
#Missing code is denoted with a "". Fill in/correct the missing code and verify that it works appropriately
...
print("Would you like to view the list or delete the list?")
